    ...
    case"3":
        ...
        while ($verif = true){
            ...
            if (5>= $salle && $salle >=1){
                ...
                // tentative de faire gagner de l'expérience après le combat
                $experience = $DAO->gagnerExpérience($idPersonnage);
                echo "\n Fin du combat";
            }
            break;
            }
            if (10>= $salle && $salle > 7 ){
                ...
                //on lance une première fois, ça fonctionne, on relance ça ne fonctionne plus ou inversement. 
